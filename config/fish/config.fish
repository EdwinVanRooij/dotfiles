...
alias et='code ~/dotfiles/config/windows-terminal-settings.json; and ~/dotfiles/manual-updates/copy-windows-terminal-settings-to-source.sh'
alias evs='code ~/dotfiles/config/vs-code-settings.json; and fish ~/dotfiles/manual-updates/copy-vs-code-settings-to-source.fish'
alias evsv='vim ~/dotfiles/config/vs-code.vimrc; and fish ~/dotfiles/manual-updates/copy-vs-code-settings-to-source.fish'
alias eps='code ~/dotfiles/config/powershell-profile.ps1; and fish ~/dotfiles/manual-updates/copy-powershell-profile-to-source.fish'
